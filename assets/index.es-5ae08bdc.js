import { a1 as getWindowMetadata_1, a2 as getDocument_1, a3 as getNavigator_1, a4 as cjs, a5 as sha256, a6 as fromString, a7 as toString, a8 as x25519, a9 as random, aa as HKDF_1, ab as chacha20poly1305, ac as concat, ad as decodeJWT, ae as queryString, af as detect, ag as getLocation_1, ah as elliptic, ai as IEvents, aj as bs$1, ak as E$1, al as y$3, Z as eventsExports, am as k, an as A$1, ao as i, ap as h$1, aq as generateKeyPair, ar as encodeIss, as as signJWT, at as safeJsonStringify, au as safeJsonParse, av as getBigIntRpcId, aw as Mg, ax as o, ay as f, az as isJsonRpcRequest, aA as isJsonRpcResponse, aB as formatJsonRpcResult, aC as Jg, aD as formatJsonRpcError, aE as isJsonRpcResult, aF as isJsonRpcError, aG as formatJsonRpcRequest, aH as r, aI as payloadId, aJ as f$1, aK as __vitePreload } from "./index-dae502c9.js";
...
class C2 {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m(this.rpc.chains) : m(this.rpc.optionalChains), this.signer = await Ev.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await __vitePreload(() => import("./index-61096303.js").then((n2) => n2.i), true ? ["./index-61096303.js","./index-dae502c9.js","./index-6434e334.css"] : void 0, import.meta.url);
        s = i2;
      } catch {
