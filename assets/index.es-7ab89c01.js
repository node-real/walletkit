import { a5 as require$$0$1, n as commonjsGlobal, aa as minimalisticAssert, a2 as inherits_browserExports, ab as hash$2, ac as getWindowMetadata_1, ad as getDocument_1, ae as getNavigator_1, af as cjs, ag as sha256, ah as fromString, ai as toString, aj as x25519, ak as random, al as HKDF_1, am as chacha20poly1305, an as concat, ao as decodeJWT, ap as queryString, aq as detect, ar as getLocation_1, as as IEvents, at as bs$1, au as E$1, av as y$3, a3 as eventsExports, aw as k, ax as A$1, ay as i, az as h$1, aA as generateKeyPair, aB as encodeIss, aC as signJWT, aD as safeJsonStringify, aE as safeJsonParse, aF as getBigIntRpcId, aG as Mg, aH as o, aI as f, aJ as isJsonRpcRequest, aK as isJsonRpcResponse, aL as formatJsonRpcResult, aM as Jg, aN as formatJsonRpcError, aO as isJsonRpcResult, aP as isJsonRpcError, aQ as formatJsonRpcRequest, aR as r$1, aS as payloadId, aT as f$1, a9 as __vitePreload } from "./index-dc75ab87.js";
var elliptic = {};
const name = "elliptic";
const version = "6.6.1";
  ...
  (function(module2, exports) {
    ...
    Red.prototype.sqrt = function sqrt(a2) {
      ...
      while (t.cmp(one) !== 0) {
        ...
        assert2(i2 < m2);
        var b2 = this.pow(c, new BN2(1).iushln(m2 - i2 - 1));
        r2 = r2.redMul(b2);
        c = b2.redSqr();
        t = t.redMul(c);
        m2 = i2;
...
Point$2.prototype.dbl = function dbl() {
  ...
  var c = x22.redAdd(x22).redIAdd(x22).redIAdd(a2).redMul(dyinv);
...
Point.prototype._projDbl = function _projDbl() {
  ...
  if (this.curve.twisted) {
    ...
    var f2 = e.redAdd(d2);
    if (this.zOne) {
      nx = b2.redSub(c).redSub(d2).redMul(f2.redSub(this.curve.two));
...
Point.prototype._projAdd = function _projAdd(p3) {
  ...
  var f2 = b2.redSub(e);
  var g3 = b2.redAdd(e);
  var tmp = this.x.redAdd(this.y).redMul(p3.x.redAdd(p3.y)).redISub(c).redISub(d2);
  var nx = a2.redMul(f2).redMul(tmp);
  var ny;
  var nz;
  if (this.curve.twisted) {
    ny = a2.redMul(g3).redMul(d2.redSub(this.curve._mulA(c)));
    nz = f2.redMul(g3);
  } else {
    ny = a2.redMul(g3).redMul(d2.redSub(c));
  ...
  (function() {
    ...
    for (var G2 = function(u3, E2, _2) {
      ...
      return function(B, R3) {
        return new s(u3, E2, R3).update(B)[_2]();
      };
    }, L2 = function(u3, E2, _2) {
      return function(B, R3, F2, P2) {
        return f2["cshake" + u3].update(B, R3, F2, P2)[_2]();
      };
    }, Pt2 = function(u3, E2, _2) {
      return function(B, R3, F2, P2) {
        return f2["kmac" + u3].update(B, R3, F2, P2)[_2]();
      };
      ...
      }, _2.update = function(B, R3) {
        return _2.create(R3).update(B);
      }, W(_2, H, u3, E2);
    }, Y = function(u3, E2) {
      var _2 = Bt2[u3], B = L2(u3, E2, "hex");
      return B.create = function(R3, F2, P2) {
        return !F2 && !P2 ? f2["shake" + u3].create(R3) : new s(u3, E2, R3).bytepad([F2, P2], _2);
      ...
      return B.create = function(R3, F2, P2) {
        return new g3(u3, E2, F2).bytepad(["KMAC", P2], _2).bytepad([R3], _2);
      }, B.update = function(R3, F2, P2, O2) {
        return B.create(R3, P2, O2).update(F2);
      }, W(B, Pt2, u3, E2);
    }, b2 = [{ name: "keccak", padding: S3, bits: D2, createMethod: Rt2 }, { name: "sha3", padding: N2, bits: D2, createMethod: Rt2 }, { name: "shake", padding: w2, bits: U2, createMethod: Vt2 }, { name: "cshake", padding: y3, bits: U2, createMethod: Y }, { name: "kmac", padding: y3, bits: U2, createMethod: Wt2 }], f2 = {}, a2 = [], c = 0; c < b2.length; ++c)
    ...
    s.prototype.update = function(u3) {
      ...
      var _2 = u3 & 255, B = 1, R3 = [_2];
      for (u3 = u3 >> 8, _2 = u3 & 255; _2 > 0; )
        R3.unshift(_2), u3 = u3 >> 8, _2 = u3 & 255, ++B;
      ...
      this.finalize();
      for (var u3 = this.blockCount, E2 = this.s, _2 = this.outputBlocks, B = this.extraBytes, R3 = 0, F2 = 0, P2 = "", O2; F2 < _2; ) {
        for (R3 = 0; R3 < u3 && F2 < _2; ++R3, ++F2)
      ...
      this.finalize();
      var u3 = this.blockCount, E2 = this.s, _2 = this.outputBlocks, B = this.extraBytes, R3 = 0, F2 = 0, P2 = this.outputBits >> 3, O2;
      ...
      this.finalize();
      for (var u3 = this.blockCount, E2 = this.s, _2 = this.outputBlocks, B = this.extraBytes, R3 = 0, F2 = 0, P2 = [], O2, Ct2; F2 < _2; ) {
        for (R3 = 0; R3 < u3 && F2 < _2; ++R3, ++F2)
...
(function(e) {
  (function(t, r2) {
    ...
    o2.prototype.toString = function(f2, a2) {
      ...
      if (f2 === 16 || f2 === "hex") {
        ...
        for (var d2 = 0, m2 = 0, x3 = 0; x3 < this.length; x3++) {
          ...
          m2 = M3 >>> 24 - d2 & 16777215, d2 += 2, d2 >= 26 && (d2 -= 26, x3--), m2 !== 0 || x3 !== this.length - 1 ? c = S3[6 - l.length] + l + c : c = l + c;
        }
      ...
      if (f2 === (f2 | 0) && f2 >= 2 && f2 <= 36) {
        ...
        for (k2.negative = 0; !k2.isZero(); ) {
          ...
          k2 = k2.idivn(g3), k2.isZero() ? c = u3 + c : c = S3[s - u3.length] + u3 + c;
        }
    ...
    var J = function(f2, a2, c) {
      ...
      M3 = (g3 + (s >>> 13) | 0) + (Me >>> 26) | 0, Me &= 67108863, l = Math.imul(B, ut2), s = Math.imul(B, ht2), s = s + Math.imul(R3, ut2) | 0, g3 = Math.imul(R3, ht2), l = l + Math.imul(u3, ct2) | 0, s = s + Math.imul(u3, lt2) | 0, s = s + Math.imul(E2, ct2) | 0, g3 = g3 + Math.imul(E2, lt2) | 0;
      var Ee2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (Ee2 >>> 26) | 0, Ee2 &= 67108863, l = Math.imul(P2, ut2), s = Math.imul(P2, ht2), s = s + Math.imul(O2, ut2) | 0, g3 = Math.imul(O2, ht2), l = l + Math.imul(B, ct2) | 0, s = s + Math.imul(B, lt2) | 0, s = s + Math.imul(R3, ct2) | 0, g3 = g3 + Math.imul(R3, lt2) | 0, l = l + Math.imul(u3, dt2) | 0, s = s + Math.imul(u3, pt2) | 0, s = s + Math.imul(E2, dt2) | 0, g3 = g3 + Math.imul(E2, pt2) | 0;
      var Se = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (Se >>> 26) | 0, Se &= 67108863, l = Math.imul(T2, ut2), s = Math.imul(T2, ht2), s = s + Math.imul(q2, ut2) | 0, g3 = Math.imul(q2, ht2), l = l + Math.imul(P2, ct2) | 0, s = s + Math.imul(P2, lt2) | 0, s = s + Math.imul(O2, ct2) | 0, g3 = g3 + Math.imul(O2, lt2) | 0, l = l + Math.imul(B, dt2) | 0, s = s + Math.imul(B, pt2) | 0, s = s + Math.imul(R3, dt2) | 0, g3 = g3 + Math.imul(R3, pt2) | 0, l = l + Math.imul(u3, vt2) | 0, s = s + Math.imul(u3, gt2) | 0, s = s + Math.imul(E2, vt2) | 0, g3 = g3 + Math.imul(E2, gt2) | 0;
      var Ie2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (Ie2 >>> 26) | 0, Ie2 &= 67108863, l = Math.imul(X, ut2), s = Math.imul(X, ht2), s = s + Math.imul($2, ut2) | 0, g3 = Math.imul($2, ht2), l = l + Math.imul(T2, ct2) | 0, s = s + Math.imul(T2, lt2) | 0, s = s + Math.imul(q2, ct2) | 0, g3 = g3 + Math.imul(q2, lt2) | 0, l = l + Math.imul(P2, dt2) | 0, s = s + Math.imul(P2, pt2) | 0, s = s + Math.imul(O2, dt2) | 0, g3 = g3 + Math.imul(O2, pt2) | 0, l = l + Math.imul(B, vt2) | 0, s = s + Math.imul(B, gt2) | 0, s = s + Math.imul(R3, vt2) | 0, g3 = g3 + Math.imul(R3, gt2) | 0, l = l + Math.imul(u3, mt2) | 0, s = s + Math.imul(u3, At2) | 0, s = s + Math.imul(E2, mt2) | 0, g3 = g3 + Math.imul(E2, At2) | 0;
      var Ne = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (Ne >>> 26) | 0, Ne &= 67108863, l = Math.imul(Z2, ut2), s = Math.imul(Z2, ht2), s = s + Math.imul(tt2, ut2) | 0, g3 = Math.imul(tt2, ht2), l = l + Math.imul(X, ct2) | 0, s = s + Math.imul(X, lt2) | 0, s = s + Math.imul($2, ct2) | 0, g3 = g3 + Math.imul($2, lt2) | 0, l = l + Math.imul(T2, dt2) | 0, s = s + Math.imul(T2, pt2) | 0, s = s + Math.imul(q2, dt2) | 0, g3 = g3 + Math.imul(q2, pt2) | 0, l = l + Math.imul(P2, vt2) | 0, s = s + Math.imul(P2, gt2) | 0, s = s + Math.imul(O2, vt2) | 0, g3 = g3 + Math.imul(O2, gt2) | 0, l = l + Math.imul(B, mt2) | 0, s = s + Math.imul(B, At2) | 0, s = s + Math.imul(R3, mt2) | 0, g3 = g3 + Math.imul(R3, At2) | 0, l = l + Math.imul(u3, bt2) | 0, s = s + Math.imul(u3, yt2) | 0, s = s + Math.imul(E2, bt2) | 0, g3 = g3 + Math.imul(E2, yt2) | 0;
      var Zr2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (Zr2 >>> 26) | 0, Zr2 &= 67108863, l = Math.imul(et2, ut2), s = Math.imul(et2, ht2), s = s + Math.imul(rt2, ut2) | 0, g3 = Math.imul(rt2, ht2), l = l + Math.imul(Z2, ct2) | 0, s = s + Math.imul(Z2, lt2) | 0, s = s + Math.imul(tt2, ct2) | 0, g3 = g3 + Math.imul(tt2, lt2) | 0, l = l + Math.imul(X, dt2) | 0, s = s + Math.imul(X, pt2) | 0, s = s + Math.imul($2, dt2) | 0, g3 = g3 + Math.imul($2, pt2) | 0, l = l + Math.imul(T2, vt2) | 0, s = s + Math.imul(T2, gt2) | 0, s = s + Math.imul(q2, vt2) | 0, g3 = g3 + Math.imul(q2, gt2) | 0, l = l + Math.imul(P2, mt2) | 0, s = s + Math.imul(P2, At2) | 0, s = s + Math.imul(O2, mt2) | 0, g3 = g3 + Math.imul(O2, At2) | 0, l = l + Math.imul(B, bt2) | 0, s = s + Math.imul(B, yt2) | 0, s = s + Math.imul(R3, bt2) | 0, g3 = g3 + Math.imul(R3, yt2) | 0, l = l + Math.imul(u3, wt2) | 0, s = s + Math.imul(u3, xt2) | 0, s = s + Math.imul(E2, wt2) | 0, g3 = g3 + Math.imul(E2, xt2) | 0;
      var ti2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (ti2 >>> 26) | 0, ti2 &= 67108863, l = Math.imul(it2, ut2), s = Math.imul(it2, ht2), s = s + Math.imul(nt2, ut2) | 0, g3 = Math.imul(nt2, ht2), l = l + Math.imul(et2, ct2) | 0, s = s + Math.imul(et2, lt2) | 0, s = s + Math.imul(rt2, ct2) | 0, g3 = g3 + Math.imul(rt2, lt2) | 0, l = l + Math.imul(Z2, dt2) | 0, s = s + Math.imul(Z2, pt2) | 0, s = s + Math.imul(tt2, dt2) | 0, g3 = g3 + Math.imul(tt2, pt2) | 0, l = l + Math.imul(X, vt2) | 0, s = s + Math.imul(X, gt2) | 0, s = s + Math.imul($2, vt2) | 0, g3 = g3 + Math.imul($2, gt2) | 0, l = l + Math.imul(T2, mt2) | 0, s = s + Math.imul(T2, At2) | 0, s = s + Math.imul(q2, mt2) | 0, g3 = g3 + Math.imul(q2, At2) | 0, l = l + Math.imul(P2, bt2) | 0, s = s + Math.imul(P2, yt2) | 0, s = s + Math.imul(O2, bt2) | 0, g3 = g3 + Math.imul(O2, yt2) | 0, l = l + Math.imul(B, wt2) | 0, s = s + Math.imul(B, xt2) | 0, s = s + Math.imul(R3, wt2) | 0, g3 = g3 + Math.imul(R3, xt2) | 0, l = l + Math.imul(u3, Mt2) | 0, s = s + Math.imul(u3, Et2) | 0, s = s + Math.imul(E2, Mt2) | 0, g3 = g3 + Math.imul(E2, Et2) | 0;
      var ei2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (ei2 >>> 26) | 0, ei2 &= 67108863, l = Math.imul(ft2, ut2), s = Math.imul(ft2, ht2), s = s + Math.imul(ot2, ut2) | 0, g3 = Math.imul(ot2, ht2), l = l + Math.imul(it2, ct2) | 0, s = s + Math.imul(it2, lt2) | 0, s = s + Math.imul(nt2, ct2) | 0, g3 = g3 + Math.imul(nt2, lt2) | 0, l = l + Math.imul(et2, dt2) | 0, s = s + Math.imul(et2, pt2) | 0, s = s + Math.imul(rt2, dt2) | 0, g3 = g3 + Math.imul(rt2, pt2) | 0, l = l + Math.imul(Z2, vt2) | 0, s = s + Math.imul(Z2, gt2) | 0, s = s + Math.imul(tt2, vt2) | 0, g3 = g3 + Math.imul(tt2, gt2) | 0, l = l + Math.imul(X, mt2) | 0, s = s + Math.imul(X, At2) | 0, s = s + Math.imul($2, mt2) | 0, g3 = g3 + Math.imul($2, At2) | 0, l = l + Math.imul(T2, bt2) | 0, s = s + Math.imul(T2, yt2) | 0, s = s + Math.imul(q2, bt2) | 0, g3 = g3 + Math.imul(q2, yt2) | 0, l = l + Math.imul(P2, wt2) | 0, s = s + Math.imul(P2, xt2) | 0, s = s + Math.imul(O2, wt2) | 0, g3 = g3 + Math.imul(O2, xt2) | 0, l = l + Math.imul(B, Mt2) | 0, s = s + Math.imul(B, Et2) | 0, s = s + Math.imul(R3, Mt2) | 0, g3 = g3 + Math.imul(R3, Et2) | 0, l = l + Math.imul(u3, St2) | 0, s = s + Math.imul(u3, It2) | 0, s = s + Math.imul(E2, St2) | 0, g3 = g3 + Math.imul(E2, It2) | 0;
      var ri2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (ri2 >>> 26) | 0, ri2 &= 67108863, l = Math.imul(st2, ut2), s = Math.imul(st2, ht2), s = s + Math.imul(at2, ut2) | 0, g3 = Math.imul(at2, ht2), l = l + Math.imul(ft2, ct2) | 0, s = s + Math.imul(ft2, lt2) | 0, s = s + Math.imul(ot2, ct2) | 0, g3 = g3 + Math.imul(ot2, lt2) | 0, l = l + Math.imul(it2, dt2) | 0, s = s + Math.imul(it2, pt2) | 0, s = s + Math.imul(nt2, dt2) | 0, g3 = g3 + Math.imul(nt2, pt2) | 0, l = l + Math.imul(et2, vt2) | 0, s = s + Math.imul(et2, gt2) | 0, s = s + Math.imul(rt2, vt2) | 0, g3 = g3 + Math.imul(rt2, gt2) | 0, l = l + Math.imul(Z2, mt2) | 0, s = s + Math.imul(Z2, At2) | 0, s = s + Math.imul(tt2, mt2) | 0, g3 = g3 + Math.imul(tt2, At2) | 0, l = l + Math.imul(X, bt2) | 0, s = s + Math.imul(X, yt2) | 0, s = s + Math.imul($2, bt2) | 0, g3 = g3 + Math.imul($2, yt2) | 0, l = l + Math.imul(T2, wt2) | 0, s = s + Math.imul(T2, xt2) | 0, s = s + Math.imul(q2, wt2) | 0, g3 = g3 + Math.imul(q2, xt2) | 0, l = l + Math.imul(P2, Mt2) | 0, s = s + Math.imul(P2, Et2) | 0, s = s + Math.imul(O2, Mt2) | 0, g3 = g3 + Math.imul(O2, Et2) | 0, l = l + Math.imul(B, St2) | 0, s = s + Math.imul(B, It2) | 0, s = s + Math.imul(R3, St2) | 0, g3 = g3 + Math.imul(R3, It2) | 0, l = l + Math.imul(u3, Nt2) | 0, s = s + Math.imul(u3, _t2) | 0, s = s + Math.imul(E2, Nt2) | 0, g3 = g3 + Math.imul(E2, _t2) | 0;
      var ii2 = (M3 + l | 0) + ((s & 8191) << 13) | 0;
      M3 = (g3 + (s >>> 13) | 0) + (ii2 >>> 26) | 0, ii2 &= 67108863, l = Math.imul(st2, ct2), s = Math.imul(st2, lt2), s = s + Math.imul(at2, ct2) | 0, g3 = Math.imul(at2, lt2), l = l + Math.imul(ft2, dt2) | 0, s = s + Math.imul(ft2, pt2) | 0, s = s + Math.imul(ot2, dt2) | 0, g3 = g3 + Math.imul(ot2, pt2) | 0, l = l + Math.imul(it2, vt2) | 0, s = s + Math.imul(it2, gt2) | 0, s = s + Math.imul(nt2, vt2) | 0, g3 = g3 + Math.imul(nt2, gt2) | 0, l = l + Math.imul(et2, mt2) | 0, s = s + Math.imul(et2, At2) | 0, s = s + Math.imul(rt2, mt2) | 0, g3 = g3 + Math.imul(rt2, At2) | 0, l = l + Math.imul(Z2, bt2) | 0, s = s + Math.imul(Z2, yt2) | 0, s = s + Math.imul(tt2, bt2) | 0, g3 = g3 + Math.imul(tt2, yt2) | 0, l = l + Math.imul(X, wt2) | 0, s = s + Math.imul(X, xt2) | 0, s = s + Math.imul($2, wt2) | 0, g3 = g3 + Math.imul($2, xt2) | 0, l = l + Math.imul(T2, Mt2) | 0, s = s + Math.imul(T2, Et2) | 0, s = s + Math.imul(q2, Mt2) | 0, g3 = g3 + Math.imul(q2, Et2) | 0, l = l + Math.imul(P2, St2) | 0, s = s + Math.imul(P2, It2) | 0, s = s + Math.imul(O2, St2) | 0, g3 = g3 + Math.imul(O2, It2) | 0, l = l + Math.imul(B, Nt2) | 0, s = s + Math.imul(B, _t2) | 0, s = s + Math.imul(R3, Nt2) | 0, g3 = g3 + Math.imul(R3, _t2) | 0;
...
ce$1.blockSize = 512, ce$1.outSize = 256, ce$1.hmacStrength = 192, ce$1.padLength = 64, ce$1.prototype._update = function(t, r2) {
  ...
  var o2 = this.h[0], h2 = this.h[1], p3 = this.h[2], A2 = this.h[3], v3 = this.h[4], w2 = this.h[5], y3 = this.h[6], S3 = this.h[7];
  for (fa(this.k.length === i2.length), n2 = 0; n2 < i2.length; n2++) {
    var N2 = sa(S3, ca(v3), aa(v3, w2, y3), this.k[n2], i2[n2]), I2 = ie(ha(o2), ua(o2, h2, p3));
    S3 = y3, y3 = w2, w2 = v3, v3 = ie(A2, N2), A2 = p3, p3 = h2, h2 = o2, o2 = ie(N2, I2);
  }
  this.h[0] = ie(this.h[0], o2), this.h[1] = ie(this.h[1], h2), this.h[2] = ie(this.h[2], p3), this.h[3] = ie(this.h[3], A2), this.h[4] = ie(this.h[4], v3), this.h[5] = ie(this.h[5], w2), this.h[6] = ie(this.h[6], y3), this.h[7] = ie(this.h[7], S3);
...
ne$1.blockSize = 1024, ne$1.outSize = 512, ne$1.hmacStrength = 192, ne$1.padLength = 128, ne$1.prototype._prepareBlock = function(t, r2) {
  ...
  for (; n2 < i2.length; n2 += 2) {
    var o2 = Pa(i2[n2 - 4], i2[n2 - 3]), h2 = Ta$1(i2[n2 - 4], i2[n2 - 3]), p3 = i2[n2 - 14], A2 = i2[n2 - 13], v3 = Ra$1(i2[n2 - 30], i2[n2 - 29]), w2 = Oa$1(i2[n2 - 30], i2[n2 - 29]), y3 = i2[n2 - 32], S3 = i2[n2 - 31];
    i2[n2] = Aa(o2, h2, p3, A2, v3, w2, y3, S3), i2[n2 + 1] = ba$1(o2, h2, p3, A2, v3, w2, y3, S3);
  }
}, ne$1.prototype._update = function(t, r2) {
  this._prepareBlock(t, r2);
  var i2 = this.W, n2 = this.h[0], o2 = this.h[1], h2 = this.h[2], p3 = this.h[3], A2 = this.h[4], v3 = this.h[5], w2 = this.h[6], y3 = this.h[7], S3 = this.h[8], N2 = this.h[9], I2 = this.h[10], C3 = this.h[11], D2 = this.h[12], U2 = this.h[13], J = this.h[14], Bt2 = this.h[15];
  ma(this.k.length === i2.length);
  for (var G2 = 0; G2 < i2.length; G2 += 2) {
    var H = J, L2 = Bt2, Pt2 = Ba(S3, N2), W = Ca(S3, N2), Rt2 = Ma(S3, N2, I2, C3, D2), Vt2 = Ea(S3, N2, I2, C3, D2, U2), Y = this.k[G2], Wt2 = this.k[G2 + 1], b2 = i2[G2], f2 = i2[G2 + 1], a2 = ya$1(H, L2, Pt2, W, Rt2, Vt2, Y, Wt2, b2, f2), c = wa(H, L2, Pt2, W, Rt2, Vt2, Y, Wt2, b2, f2);
    H = Na$1(n2, o2), L2 = _a(n2, o2), Pt2 = Sa$1(n2, o2, h2, p3, A2), W = Ia(n2, o2, h2, p3, A2, v3);
    var d2 = Fi$1(H, L2, Pt2, W), m2 = Ui(H, L2, Pt2, W);
    J = D2, Bt2 = U2, D2 = I2, U2 = C3, I2 = S3, C3 = N2, S3 = Fi$1(w2, y3, a2, c), N2 = Ui(y3, y3, a2, c), w2 = A2, y3 = v3, A2 = h2, v3 = p3, h2 = n2, p3 = o2, n2 = Fi$1(a2, c, d2, m2), o2 = Ui(a2, c, d2, m2);
  }
  Be(this.h, 0, n2, o2), Be(this.h, 2, h2, p3), Be(this.h, 4, A2, v3), Be(this.h, 6, w2, y3), Be(this.h, 8, S3, N2), Be(this.h, 10, I2, C3), Be(this.h, 12, D2, U2), Be(this.h, 14, J, Bt2);
...
Xe$1.inherits(pe, Ff), Pf.ripemd160 = pe, pe.blockSize = 512, pe.outSize = 160, pe.hmacStrength = 192, pe.padLength = 64, pe.prototype._update = function(t, r2) {
  for (var i2 = this.h[0], n2 = this.h[1], o2 = this.h[2], h2 = this.h[3], p3 = this.h[4], A2 = i2, v3 = n2, w2 = o2, y3 = h2, S3 = p3, N2 = 0; N2 < 80; N2++) {
    var I2 = Tf(Kr$1(Df(i2, Uf(N2, n2, o2, h2), t[qa$1[N2] + r2], Ua$1(N2)), Ha$1[N2]), p3);
    i2 = p3, p3 = h2, h2 = Kr$1(o2, 10), o2 = n2, n2 = I2, I2 = Tf(Kr$1(Df(A2, Uf(79 - N2, v3, w2, y3), t[Ka[N2] + r2], ka(N2)), La$1[N2]), S3), A2 = S3, S3 = y3, y3 = Kr$1(w2, 10), w2 = v3, v3 = I2;
  }
  I2 = Er$1(this.h[1], o2, y3), this.h[1] = Er$1(this.h[2], h2, S3), this.h[2] = Er$1(this.h[3], p3, A2), this.h[3] = Er$1(this.h[4], i2, v3), this.h[4] = Er$1(this.h[0], n2, w2), this.h[0] = I2;
...
var fe$1 = lr$2(function(e, t) {
  ...
  function i2(h2, p3) {
    ...
    if (p3 === "hex") {
      ...
      for (var v3 = 0; v3 < h2.length; v3++) {
        var w2 = h2.charCodeAt(v3), y3 = w2 >> 8, S3 = w2 & 255;
...
Ce$2.prototype.point = function() {
  ...
  for (var w2 = this.jpoint(null, null, null), y3 = this.jpoint(null, null, null), S3 = o2; S3 > 0; S3--) {
    for (p3 = 0; p3 < h2.length; p3++)
      A2 = h2[p3], A2 === S3 ? y3 = y3.mixedAdd(i2.points[p3]) : A2 === -S3 && (y3 = y3.mixedAdd(i2.points[p3].neg()));
    w2 = w2.add(y3);
  }
  return w2.toP();
  ...
  var h2 = this._wnafT1, p3 = this._wnafT2, A2 = this._wnafT3, v3 = 0, w2, y3, S3;
  for (w2 = 0; w2 < n2; w2++) {
    S3 = r2[w2];
...
te$1.prototype._getEndomorphism = function(t) {
  ...
  for (var r2 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i2 = t, n2 = this.n.clone(), o2 = new K(1), h2 = new K(0), p3 = new K(0), A2 = new K(1), v3, w2, y3, S3, N2, I2, C3, D2 = 0, U2, J; i2.cmpn(0) !== 0; ) {
    var Bt2 = n2.div(i2);
  ...
  var r2 = this.endo.basis, i2 = r2[0], n2 = r2[1], o2 = n2.b.mul(t).divRound(this.n), h2 = i2.b.neg().mul(t).divRound(this.n), p3 = o2.mul(i2.a), A2 = h2.mul(n2.a), v3 = o2.mul(i2.b), w2 = h2.mul(n2.b), y3 = t.sub(p3).sub(A2), S3 = v3.add(w2).neg();
  return { k1: y3, k2: S3 };
...
Ki(Ft$1, $e.BasePoint), te$1.prototype.jpoint = function(t, r2, i2) {
  ...
  var w2 = A2.redSqr(), y3 = w2.redMul(A2), S3 = n2.redMul(w2), N2 = v3.redSqr().redIAdd(y3).redISub(S3).redISub(S3), I2 = v3.redMul(S3.redISub(N2)).redISub(h2.redMul(y3)), C3 = this.z.redMul(t.z).redMul(A2);
  ...
  for (r2 = 0; r2 < t; r2++) {
    var y3 = h2.redSqr(), S3 = w2.redSqr(), N2 = S3.redSqr(), I2 = y3.redAdd(y3).redIAdd(y3).redIAdd(n2.redMul(v3)), C3 = h2.redMul(S3), D2 = I2.redSqr().redISub(C3.redAdd(C3)), U2 = C3.redISub(D2), J = I2.redMul(U2);
...
const Wf = (e, t) => {
  ...
  const o2 = `URI: ${e.aud || e.uri}`, h2 = `Version: ${e.version}`, p3 = `Chain ID: ${Yi(t)}`, A2 = `Nonce: ${e.nonce}`, v3 = `Issued At: ${e.iat}`, w2 = e.exp ? `Expiration Time: ${e.exp}` : void 0, y3 = e.nbf ? `Not Before: ${e.nbf}` : void 0, S3 = e.requestId ? `Request ID: ${e.requestId}` : void 0, N2 = e.resources ? `Resources:${e.resources.map((C3) => `
- ${C3}`).join("")}` : void 0, I2 = Vr$1(e.resources);
  if (I2) {
    const C3 = Oe(I2);
    n2 = $i(n2, C3);
  }
  return [r2, i2, "", n2, "", o2, h2, p3, A2, v3, w2, y3, S3, N2].filter((C3) => C3 != null).join(`
`);
};
function to(e) {
    ...
    super(o2), this.name = nt, this.events = new Jg(), this.initialized = false, this.requestQueue = { state: x$1.idle, queue: [] }, this.sessionRequestQueue = { state: x$1.idle, queue: [] }, this.requestQueueDelay = cjs.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.relayMessageCache = [], this.init = async () => {
      ...
      this.events.once(Ms$1("session_connect"), async ({ error: E2, session: S3 }) => {
        if (E2)
          ...
          await this.client.session.set(S3.topic, M3), await this.setExpiry(S3.topic, S3.expiry), c && await this.client.core.pairing.updateMetadata({ topic: c, metadata: S3.peer.metadata }), this.cleanupDuplicatePairings(M3), _2(M3);
        }
      });
      const V2 = await this.sendRequest({ topic: c, method: "wc_sessionPropose", params: m2, throwOnFailedPublish: true });
      return await this.setProposal(V2, I({ id: V2 }, m2)), { uri: h2, approval: R3 };
    }, this.pair = async (e) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      const R3 = await this.client.core.crypto.generateKeyPair(), V2 = w2.publicKey, E2 = await this.client.core.crypto.generateSharedKey(R3, V2), S3 = I(I({ relay: { protocol: a2 ?? "irn" }, namespaces: c, controller: { publicKey: R3, metadata: this.client.metadata }, expiry: ws$1(z2) }, h2 && { sessionProperties: h2 }), p3 && { sessionConfig: p3 }), M3 = F$1.relay;
      ...
      const W = D$1(I({}, S3), { topic: E2, requiredNamespaces: m2, optionalNamespaces: y3, pairingTopic: l, acknowledged: false, self: S3.controller, peer: { publicKey: w2.publicKey, metadata: w2.metadata }, controller: R3, transportType: F$1.relay });
      await this.client.session.set(E2, W), _2.addTrace(Cs.store_session);
      try {
        _2.addTrace(Cs.publishing_session_settle), await this.sendRequest({ topic: E2, method: "wc_sessionSettle", params: S3, throwOnFailedPublish: true }).catch((N2) => {
          throw _2 == null ? void 0 : _2.setError(Ss$1.session_settle_publish_failure), N2;
        }), _2.addTrace(Cs.session_settle_publish_success), _2.addTrace(Cs.publishing_session_approve), await this.sendResult({ id: n2, topic: l, result: { relay: { protocol: a2 ?? "irn" }, responderPublicKey: R3 }, throwOnFailedPublish: true }).catch((N2) => {
      ...
      const { chains: n2, statement: a2 = "", uri: c, domain: h2, nonce: p3, type: d2, exp: l, nbf: w2, methods: m2 = [], expiry: y3 } = e, _2 = [...e.resources || []], { topic: R3, uri: V2 } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: r2 });
      ...
      for (const y3 of s) {
        if (!await mu({ cacao: y3, projectId: this.client.core.projectId })) {
          ...
          throw await this.sendError({ id: t, topic: h2, error: S3, encodeOpts: p3 }), new Error(S3.message);
        }
        i2.addTrace(Ps.cacaos_verified);
        const { p: _2 } = y3, R3 = Vr$1(_2.resources), V2 = [gu(_2.iss)], E2 = Vi(_2.iss);
        if (R3) {
...
(function(P2, s) {
  (function() {
    ...
    function uc(h2, g3, d2, A2) {
      for (var R3 = -1, U2 = h2 == null ? 0 : h2.length; ++R3 < U2; ) {
        var Q2 = h2[R3];
        g3(A2, Q2, d2(Q2), h2);
      }
      return A2;
    ...
    function ne2(h2, g3) {
      for (var d2 = -1, A2 = h2 == null ? 0 : h2.length, R3 = 0, U2 = []; ++d2 < A2; ) {
        var Q2 = h2[d2];
        g3(Q2, d2, h2) && (U2[R3++] = Q2);
      }
      return U2;
    }
    function Sn2(h2, g3) {
    ...
    function Dr2(h2, g3, d2) {
      for (var A2 = -1, R3 = h2 == null ? 0 : h2.length; ++A2 < R3; )
        if (d2(g3, h2[A2]))
          return true;
      return false;
    }
    function z3(h2, g3) {
      for (var d2 = -1, A2 = h2 == null ? 0 : h2.length, R3 = Array(A2); ++d2 < A2; )
        R3[d2] = g3(h2[d2], d2, h2);
      return R3;
    }
    function re2(h2, g3) {
      for (var d2 = -1, A2 = g3.length, R3 = h2.length; ++d2 < A2; )
        h2[R3 + d2] = g3[d2];
      return h2;
    }
    function Nr2(h2, g3, d2, A2) {
      var R3 = -1, U2 = h2 == null ? 0 : h2.length;
      for (A2 && U2 && (d2 = h2[++R3]); ++R3 < U2; )
        d2 = g3(d2, h2[R3], R3, h2);
      return d2;
    }
    function oc(h2, g3, d2, A2) {
      var R3 = h2 == null ? 0 : h2.length;
      for (A2 && R3 && (d2 = h2[--R3]); R3--; )
        d2 = g3(d2, h2[R3], R3, h2);
      return d2;
    }
    function $r2(h2, g3) {
    ...
    function xs2(h2, g3, d2) {
      var A2;
      return d2(h2, function(R3, U2, Q2) {
        if (g3(R3, U2, Q2))
          return A2 = U2, false;
      }), A2;
    }
    function On2(h2, g3, d2, A2) {
      for (var R3 = h2.length, U2 = d2 + (A2 ? 1 : -1); A2 ? U2-- : ++U2 < R3; )
        if (g3(h2[U2], U2, h2))
          return U2;
      return -1;
    }
    ...
    function lc(h2, g3, d2, A2) {
      for (var R3 = d2 - 1, U2 = h2.length; ++R3 < U2; )
        if (A2(h2[R3], g3))
          return R3;
      return -1;
    }
    ...
    function Ss2(h2, g3, d2, A2, R3) {
      return R3(h2, function(U2, Q2, M3) {
    ...
    function Fr2(h2, g3) {
      for (var d2, A2 = -1, R3 = h2.length; ++A2 < R3; ) {
        var U2 = g3(h2[A2]);
    ...
    function Br2(h2) {
      ...
      return h2.forEach(function(A2, R3) {
        d2[++g3] = [R3, A2];
      }), d2;
    }
    function Ts2(h2, g3) {
    ...
    function ie2(h2, g3) {
      for (var d2 = -1, A2 = h2.length, R3 = 0, U2 = []; ++d2 < A2; ) {
        var Q2 = h2[d2];
        (Q2 === g3 || Q2 === Ie2) && (h2[d2] = Ie2, U2[R3++] = d2);
      }
      return U2;
    }
    function Rn2(h2) {
    ...
    function Ic(h2, g3, d2) {
      for (var A2 = d2 - 1, R3 = h2.length; ++A2 < R3; )
        if (h2[A2] === g3)
          return A2;
      return -1;
    }
    ...
    var Rc = function h2(g3) {
      ...
      function Ct2(t, e, n2, r2, u3, o2) {
        ...
        var S3 = v3 ? l ? di2 : pi2 : l ? ot2 : k2, L2 = _2 ? i2 : S3(t);
      ...
      function kr2(t, e, n2) {
        ...
        t:
          for (; ++m2 < u3 && v3.length < l; ) {
            var x3 = _2[m2], S3 = e ? e(x3) : x3;
            if (x3 = n2 || x3 !== 0 ? x3 : 0, !(C3 ? tn2(C3, S3) : r2(v3, S3, n2))) {
              for (c = o2; --c; ) {
                var L2 = f2[c];
                if (!(L2 ? tn2(L2, S3) : r2(t[c], S3, n2)))
                  continue t;
              }
      ...
      function Nf2(t, e, n2, r2, u3, o2) {
        ...
        if (!(n2 & Ee2)) {
          var x3 = _2 && W.call(t, "__wrapped__"), S3 = m2 && W.call(e, "__wrapped__");
          if (x3 || S3) {
      ...
      function Mf2(t, e, n2, r2, u3, o2, c) {
        ...
        if (m2) {
          var C3 = b2(l), x3 = !C3 && fe2(l), S3 = !C3 && !x3 && Be2(l);
          _2 = l, C3 || x3 || S3 ? b2(f2) ? _2 = f2 : Z2(f2) ? _2 = ut2(f2) : x3 ? (m2 = false, _2 = pu2(l, true)) : S3 ? (m2 = false, _2 = du2(l, true)) : _2 = [] : gn2(l) || Ce2(l) ? (_2 = f2, Ce2(f2) ? _2 = fa2(f2) : (!K2(f2) || Vt2(f2)) && (_2 = Lu2(l))) : m2 = false;
        }
      ...
      function si2(t, e, n2, r2) {
        ...
        for (var c = e !== e, f2 = e === null, l = pt2(e), v3 = e === i2; u3 < o2; ) {
          var _2 = Wn2((u3 + o2) / 2), m2 = n2(t[_2]), C3 = m2 !== i2, x3 = m2 === null, S3 = m2 === m2, L2 = pt2(m2);
          if (c)
            var O2 = r2 || S3;
          else
            v3 ? O2 = S3 && (r2 || C3) : f2 ? O2 = S3 && C3 && (r2 || !x3) : l ? O2 = S3 && C3 && !x3 && (r2 || !L2) : x3 || L2 ? O2 = false : O2 = r2 ? m2 <= e : m2 < e;
          O2 ? u3 = _2 + 1 : o2 = _2;
        }
        return et2(o2, Za2);
      }
      ...
      function Vn2(t, e, n2, r2, u3, o2, c, f2, l, v3) {
        var _2 = e & Gt2, m2 = e & vt2, C3 = e & he2, x3 = e & (Nt2 | ye2), S3 = e & gr2, L2 = C3 ? i2 : ln2(t);
        function O2() {
          ...
          return D2 = $2.length, f2 ? $2 = xh2($2, f2) : S3 && D2 > 1 && $2.reverse(), _2 && l < D2 && ($2.length = l), this && this !== j2 && this instanceof O2 && (jt2 = L2 || ln2(jt2)), jt2.apply(bt2, $2);
        }
        return O2;
      }
      function Iu2(t, e) {
      ...
      function Eu2(t, e, n2, r2, u3, o2, c, f2, l, v3) {
        var _2 = e & Nt2, m2 = _2 ? c : i2, C3 = _2 ? i2 : c, x3 = _2 ? o2 : i2, S3 = _2 ? i2 : o2;
        e |= _2 ? $t2 : Se, e &= ~(_2 ? Se : $t2), e & Gi2 || (e &= ~(vt2 | he2));
        var L2 = [t, e, u3, x3, m2, S3, C3, f2, l, v3], O2 = n2.apply(i2, L2);
      ...
      function Ru2(t, e, n2, r2, u3, o2) {
        ...
        for (o2.set(t, e), o2.set(e, t); ++m2 < f2; ) {
          var S3 = t[m2], L2 = e[m2];
          if (r2)
            var O2 = c ? r2(L2, S3, m2, e, t, o2) : r2(S3, L2, m2, t, e, o2);
          if (O2 !== i2) {
            if (O2)
              continue;
            C3 = false;
...
`;
          ...
          throw new R3(J);
        m2 = (l ? m2.replace(ro2, "") : m2).replace(io, "$1").replace(so2, "$1;"), m2 = "function(" + (S3 || "obj") + `) {
` + (S3 ? "" : `obj || (obj = {});
...
`) + m2 + `return __p
      ...
      return a2.after = sp, a2.ary = Vu2, a2.assign = Jp, a2.assignIn = ha2, a2.assignInWith = hr2, a2.assignWith = Yp, a2.at = Zp, a2.before = ku2, a2.bind = xi2, a2.bindAll = jd, a2.bindKey = ju2, a2.castArray = _p, a2.chain = Zu2, a2.chunk = yh2, a2.compact = Sh2, a2.concat = Oh, a2.cond = tg, a2.conforms = eg, a2.constant = Ti2, a2.countBy = $l, a2.create = Xp, a2.curry = ta2, a2.curryRight = ea2, a2.debounce = na2, a2.defaults = Qp, a2.defaultsDeep = Vp, a2.defer = up, a2.delay = ap, a2.difference = Rh2, a2.differenceBy = bh2, a2.differenceWith = Th, a2.drop = Lh, a2.dropRight = Hh, a2.dropRightWhile = Dh, a2.dropWhile = Nh2, a2.fill = $h, a2.filter = ql, a2.flatMap = Ml, a2.flatMapDeep = Bl, a2.flatMapDepth = Gl, a2.flatten = zu2, a2.flattenDeep = Uh, a2.flattenDepth = qh, a2.flip = op, a2.flow = rg, a2.flowRight = ig, a2.fromPairs = Fh, a2.functions = id, a2.functionsIn = sd, a2.groupBy = zl, a2.initial = Mh2, a2.intersection = Bh2, a2.intersectionBy = Gh, a2.intersectionWith = zh, a2.invert = ad, a2.invertBy = od, a2.invokeMap = Jl, a2.iteratee = Li2, a2.keyBy = Yl, a2.keys = k2, a2.keysIn = ot2, a2.map = sr2, a2.mapKeys = fd, a2.mapValues = hd, a2.matches = sg, a2.matchesProperty = ug, a2.memoize = ar2, a2.merge = ld, a2.mergeWith = la2, a2.method = ag, a2.methodOf = og, a2.mixin = Hi2, a2.negate = or2, a2.nthArg = fg, a2.omit = pd, a2.omitBy = dd, a2.once = cp, a2.orderBy = Zl, a2.over = hg, a2.overArgs = fp, a2.overEvery = lg, a2.overSome = pg, a2.partial = Ei2, a2.partialRight = ra2, a2.partition = Xl, a2.pick = gd, a2.pickBy = pa2, a2.property = Pa2, a2.propertyOf = dg, a2.pull = Zh, a2.pullAll = Ju2, a2.pullAllBy = Xh, a2.pullAllWith = Qh, a2.pullAt = Vh, a2.range = gg, a2.rangeRight = vg, a2.rearg = hp, a2.reject = kl, a2.remove = kh, a2.rest = lp, a2.reverse = Ai, a2.sampleSize = tp, a2.set = _d, a2.setWith = md, a2.shuffle = ep, a2.slice = jh, a2.sortBy = ip, a2.sortedUniq = ul, a2.sortedUniqBy = al, a2.split = Md, a2.spread = pp, a2.tail = ol, a2.take = cl, a2.takeRight = fl, a2.takeRightWhile = hl, a2.takeWhile = ll, a2.tap = Sl, a2.throttle = dp, a2.thru = ir2, a2.toArray = oa2, a2.toPairs = da2, a2.toPairsIn = ga2, a2.toPath = Cg, a2.toPlainObject = fa2, a2.transform = wd, a2.unary = gp, a2.union = pl, a2.unionBy = dl, a2.unionWith = gl, a2.uniq = vl, a2.uniqBy = _l, a2.uniqWith = ml, a2.unset = Pd, a2.unzip = Ii2, a2.unzipWith = Yu2, a2.update = Cd, a2.updateWith = Ad, a2.values = Ge, a2.valuesIn = Id, a2.without = wl, a2.words = ma2, a2.wrap = vp, a2.xor = Pl, a2.xorBy = Cl, a2.xorWith = Al, a2.zip = Il, a2.zipObject = xl, a2.zipObjectDeep = El, a2.zipWith = yl, a2.entries = da2, a2.entriesIn = ga2, a2.extend = ha2, a2.extendWith = hr2, Hi2(a2, a2), a2.add = Ig, a2.attempt = wa2, a2.camelCase = Sd, a2.capitalize = va2, a2.ceil = xg, a2.clamp = xd, a2.clone = mp, a2.cloneDeep = Pp, a2.cloneDeepWith = Cp, a2.cloneWith = wp, a2.conformsTo = Ap, a2.deburr = _a2, a2.defaultTo = ng, a2.divide = Eg, a2.endsWith = Od, a2.eq = Rt2, a2.escape = Rd, a2.escapeRegExp = bd, a2.every = Ul, a2.find = Fl, a2.findIndex = Bu2, a2.findKey = kp, a2.findLast = Wl, a2.findLastIndex = Gu2, a2.findLastKey = jp, a2.floor = yg, a2.forEach = Xu2, a2.forEachRight = Qu2, a2.forIn = td, a2.forInRight = ed, a2.forOwn = nd, a2.forOwnRight = rd, a2.get = Oi2, a2.gt = Ip, a2.gte = xp, a2.has = ud, a2.hasIn = Ri2, a2.head = Ku2, a2.identity = ct2, a2.includes = Kl, a2.indexOf = Wh, a2.inRange = Ed, a2.invoke = cd, a2.isArguments = Ce2, a2.isArray = b2, a2.isArrayBuffer = Ep, a2.isArrayLike = at2, a2.isArrayLikeObject = Z2, a2.isBoolean = yp, a2.isBuffer = fe2, a2.isDate = Sp, a2.isElement = Op, a2.isEmpty = Rp, a2.isEqual = bp, a2.isEqualWith = Tp, a2.isError = yi2, a2.isFinite = Lp, a2.isFunction = Vt2, a2.isInteger = ia2, a2.isLength = cr2, a2.isMap = sa2, a2.isMatch = Hp, a2.isMatchWith = Dp, a2.isNaN = Np, a2.isNative = $p, a2.isNil = qp, a2.isNull = Up, a2.isNumber = ua2, a2.isObject = K2, a2.isObjectLike = Y, a2.isPlainObject = gn2, a2.isRegExp = Si2, a2.isSafeInteger = Fp, a2.isSet = aa2, a2.isString = fr2, a2.isSymbol = pt2, a2.isTypedArray = Be2, a2.isUndefined = Wp, a2.isWeakMap = Mp, a2.isWeakSet = Bp, a2.join = Kh, a2.kebabCase = Td, a2.last = It2, a2.lastIndexOf = Jh, a2.lowerCase = Ld, a2.lowerFirst = Hd, a2.lt = Gp, a2.lte = zp, a2.max = Sg, a2.maxBy = Og, a2.mean = Rg, a2.meanBy = bg, a2.min = Tg, a2.minBy = Lg, a2.stubArray = Ni2, a2.stubFalse = $i2, a2.stubObject = _g, a2.stubString = mg, a2.stubTrue = wg, a2.multiply = Hg, a2.nth = Yh, a2.noConflict = cg, a2.noop = Di2, a2.now = ur2, a2.pad = Dd, a2.padEnd = Nd, a2.padStart = $d, a2.parseInt = Ud, a2.random = yd, a2.reduce = Ql, a2.reduceRight = Vl, a2.repeat = qd, a2.replace = Fd, a2.result = vd, a2.round = Dg, a2.runInContext = h2, a2.sample = jl, a2.size = np, a2.snakeCase = Wd, a2.some = rp, a2.sortedIndex = tl, a2.sortedIndexBy = el, a2.sortedIndexOf = nl, a2.sortedLastIndex = rl, a2.sortedLastIndexBy = il, a2.sortedLastIndexOf = sl, a2.startCase = Bd, a2.startsWith = Gd, a2.subtract = Ng, a2.sum = $g, a2.sumBy = Ug, a2.template = zd, a2.times = Pg, a2.toFinite = kt2, a2.toInteger = T2, a2.toLength = ca2, a2.toLower = Kd, a2.toNumber = xt2, a2.toSafeInteger = Kp, a2.toString = q2, a2.toUpper = Jd, a2.trim = Yd, a2.trimEnd = Zd, a2.trimStart = Xd, a2.truncate = Qd, a2.unescape = Vd, a2.uniqueId = Ag, a2.upperCase = kd, a2.upperFirst = bi2, a2.each = Xu2, a2.eachRight = Qu2, a2.first = Ku2, Hi2(a2, function() {
        ...
        u3 && (a2.prototype[e] = function() {
          ...
          var C3 = this.__chain__, x3 = !!this.__actions__.length, S3 = o2 && !C3, L2 = l && !x3;
          if (!o2 && _2) {
            c = L2 ? c : new N2(this);
            var O2 = t.apply(c, f2);
...
class C2 {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m(this.rpc.chains) : m(this.rpc.optionalChains), this.signer = await Ev.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await __vitePreload(() => import("./index-6601b385.js").then((n2) => n2.i), true ? ["./index-6601b385.js","./index-dc75ab87.js","./index-51b56c12.css"] : void 0, import.meta.url);
        s = i2;
      } catch {
