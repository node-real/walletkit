import { a5 as require$$0$1, l as commonjsGlobal, aa as minimalisticAssert, a2 as inherits_browserExports, ab as hash$2, ac as getWindowMetadata_1, ad as getDocument_1, ae as getNavigator_1, af as cjs, ag as sha256, ah as fromString, ai as toString, aj as x25519, ak as random, al as HKDF_1, am as chacha20poly1305, an as concat, ao as decodeJWT, ap as queryString, aq as detect, ar as getLocation_1, as as IEvents, at as bs$1, au as E$1, av as y$3, a3 as eventsExports, aw as k, ax as A$1, ay as i, az as h$1, aA as generateKeyPair, aB as encodeIss, aC as signJWT, aD as safeJsonStringify, aE as safeJsonParse, aF as getBigIntRpcId, aG as Mg, aH as o, aI as f, aJ as isJsonRpcRequest, aK as isJsonRpcResponse, aL as formatJsonRpcResult, aM as Jg, aN as formatJsonRpcError, aO as isJsonRpcResult, aP as isJsonRpcError, aQ as formatJsonRpcRequest, aR as r$1, aS as payloadId, aT as f$1, a9 as __vitePreload } from "./index-ea1b4fb8.js";
var elliptic = {};
const name = "elliptic";
const version = "6.6.1";
...
class C2 {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m(this.rpc.chains) : m(this.rpc.optionalChains), this.signer = await Ev.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await __vitePreload(() => import("./index-3ba6b2d8.js").then((n2) => n2.i), true ? ["./index-3ba6b2d8.js","./index-ea1b4fb8.js","./index-51b56c12.css"] : void 0, import.meta.url);
        s = i2;
      } catch {
