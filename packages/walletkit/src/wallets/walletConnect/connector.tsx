// https://github.com/wevm/references/blob/7d02972803714e47a24ea9f5de33d91f384025b9/packages/connectors/src/walletConnect.ts
...
type EthereumProviderOptions = Parameters<WalletConnectProvider['initialize']>[0];
...
type WalletConnectOptions = {
  ...
  relayUrl?: EthereumProviderOptions['relayUrl'];
};
