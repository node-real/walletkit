...
export function BscIcon(props: SVGIconProps) {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" {...props}>
      ...
      <defs>
        <pattern id="BscIconPattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
          <use xlinkHref="#image0_2258_278" transform="translate(0.0514019) scale(0.00934579)" />
        </pattern>
        <image
          id="image0_2258_278"
          width="96"
